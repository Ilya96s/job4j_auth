...
/**
 * JWTAuthorizationFilter - обеспечивает проверку действительности токенов JWT и аутентификацию пользователей на основе этих токенов
 *
 * @author IlyaKaltygin
 */
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    /**
     * Перехватыывет запрос и проверяет, содержит ли заголовок запроса токен JWT. Если токен действительный, то устанавливается контекст безопасности
